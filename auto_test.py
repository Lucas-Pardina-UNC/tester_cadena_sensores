...
async def auto_test_cycle(client, responsive_slaves: list, log_data: list, filename: str = "modbus_test_log.txt", chain_id: int = 0) -> None:
...
def log_to_file(log_data: list, timestamp: Optional[str] = None, filename: str = "modbus_test_log.txt") -> None:
    """Logs data to a file."""
