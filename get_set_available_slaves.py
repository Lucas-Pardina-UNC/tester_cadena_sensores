...
async def list_sensors(client, filename="available_slaves.txt") -> list:
...
async def input_manual_slaves(responsive_slaves: list, filename="available_slaves.txt") -> None:
...
def get_responsive_slaves(filename="available_slaves.txt") -> list:
