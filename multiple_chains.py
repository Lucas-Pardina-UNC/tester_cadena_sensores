...
async def run_client_multiple(num_chains: int, chains_ports: list, slave_info_file_names: list, log_file_names_raw: list) -> None:
...
async def auto_test_multiple(num_chains: int, chain_clients: list, chain_responsive_slaves: list, log_file_names_raw: list) -> None:    
