...
Function CheckPython
    ...
    ${If} $0 != ""
        ...
        nsExec::ExecToStack 'pip install waitress'
        nsExec::ExecToStack 'pip install Flask'
        nsExec::ExecToStack 'pip install flask-cors'
        nsExec::ExecToStack 'pip install asyncio'
        nsExec::ExecToStack 'pip install pymodbus>=3.2.0'
        nsExec::ExecToStack 'pip install openpyxl'
        nsExec::ExecToStack 'pip install pyserial'
        nsExec::ExecToStack 'pip install tkinter'
        nsExec::ExecToStack 'pip install multiprocessing'
        nsExec::ExecToStack 'pip install platform'
    ${EndIf}
    Return
